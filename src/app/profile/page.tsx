  ...
  return (
    <div className="py-4 w-full flex flex-col max-w-2xl mx-auto">
      <div className="flex flex-col gap-3 w-full">
        <Link href="/dashboard">
          <Button
            className="w-full !bg-card/60 animate-in fade-in slide-in-from-bottom-6 duration-1000 ease-out"
            variant="outline"
            style={{
        ...
        {/* Profile Information */}
        <Card
          className="animate-in fade-in slide-in-from-bottom-6 duration-1000 ease-out delay-300"
          style={{
            animationFillMode: "both",
          }}
        >
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Your email is connected to your account provider and cannot be changed
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        {/* Account Actions */}
        <Card
          className="animate-in fade-in slide-in-from-bottom-6 duration-1000 ease-out delay-450"
          style={{
            animationFillMode: "both",
          }}
        >
